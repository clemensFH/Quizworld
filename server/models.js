class User {
 ...
 class Quiz {
    constructor(title, apiURL, numberOfQuestions, category, creatorID, date, description, questions) {
        this.title = title
        this.apiURL = apiURL
...
Quiz1 = new Quiz("Test", null, 2, ["Science", "Mathematics", "Technology"], user2.name, new Date("2023-03-06").toLocaleDateString("de-DE"), "Best physics quiz", [q1,q2])
Quiz2 = new Quiz("Best",  null,2, ["Sports"], user3.name, new Date("2023-02-05").toLocaleDateString("de-DE"), "Best sports quiz",[q3,q2])
